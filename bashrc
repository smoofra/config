...
export PATH=$($HOME/bin/addpath $HOME/bin.local $HOME/bin $HOME/usr/bin /usr/lib/git-core "$PATH")
...
alias slrn='env NNTPSERVER=news.gmane.org HOSTNAME=cthulhu.elder-gods.org slrn'